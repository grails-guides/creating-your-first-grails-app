...
----
include::{sourceDir}/src/test/groovy/org/grails/guides/ValueEstimateServiceSpec.groovy[]
----
<1> When mocking multiple objects using the updated testing framework in Grails 3.3 we now perform mocks during setup and no
longer require the @Mock annotation.
