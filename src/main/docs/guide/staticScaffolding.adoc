...
[source, bash]
----
$ ./grailsw generate-controller demo.Vehicle
----
...
[source, bash]
----
$ ./grailsw generate-all demo.Vehicle
----
...
[source, bash]
----
$ ./grailsw generate-all demo.Vehicle -force
----

Open the `VehicleController.groovy` file at `grails-app/controllers/demo/`.

[source, groovy]
----
include::{sourceDir}/grails-app/controllers/demo/staticscaffolding/VehicleController.groovy[indent=0,lines="4..8,10..114"]
----
