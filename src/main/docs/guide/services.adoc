...
Edit `grails-app/controllers/com/example/VehicleController.groovy` (the scaffolded controller we generated earlier), and add the property shown below:

[source,groovy]
.grails-app/controllers/com/example/VehicleController.groovy
----
include::{sourceDir}/grails-app/controllers/com/example/VehicleController.groovy[indent=0,lines="6..11"]
----
...
.grails-app/controllers/com/example/VehicleController.groovy
----
include::{sourceDir}/grails-app/controllers/com/example/VehicleController.groovy[indent=0,lines="18..20"]
----
