...
----
include::{sourceDir}/grails-app/controllers/org/grails/guides/scaffolding/VehicleController.groovy[indent=0,lines="16..18"]
----
...
.grails-app/controllers/org/grails/guides/VehicleController.groovy
----
include::{sourceDir}/grails-app/controllers/org/grails/guides/VehicleController.groovy[indent=0,lines="24..26"]
----
