...
[source, bash]
----
$ ./grailsw create-service demo.ValueEstimateService

| Created grails-app/services/demo/ValueEstimateService.groovy
| Created src/test/groovy/demo/ValueEstimateServiceSpec.groovy
----

Edit `grails-app/services/demo/ValueEstimateService.groovy`

[source,groovy]
.grails-app/services/demo/ValueEstimateService.groovy
----
package demo
...
.grails-app/services/demo/ValueEstimateService.groovy
----
include::{sourceDir}/grails-app/services/demo/ValueEstimateService.groovy[]
----
...
Edit `grails-app/controllers/demo/VehicleController.groovy` (the scaffolded controller we generated earlier), and add the property shown below:

[source,groovy]
.grails-app/controllers/demo/VehicleController.groovy
----
include::{sourceDir}/grails-app/controllers/demo/VehicleController.groovy[indent=0,lines="6..11"]
----
...
.grails-app/controllers/demo/VehicleController.groovy
----
include::{sourceDir}/grails-app/controllers/demo/VehicleController.groovy[indent=0,lines="18..20"]
----
